...
enum class EventBossType(val id: Int, val positions: MutableList<Position>, val hitpoints: Int, val message: MutableList<String>, val rolls: Int, val lootTable: LootTable, val embedUrl: String, val pet: Pet, val petChance: Int) {
    ...
    TEST_BOSS(143, mutableListOf(
            Position.of(3017, 3300, 0)
    ), 5000, mutableListOf("The test world boss has spawned at coords 3017, 3300, 0"), 1, BrutalLavaDragonLoot(),
            "https://i.imgur.com/uZWY3ap.png", Pet.LAZY_CAT2, 1)
    ...
    //"https://i.imgur.com/hnjb4vw.png", Pet.LAZY_CAT1, 150),
    ...
    //"https://i.imgur.com/uZWY3ap.png", Pet.LAZY_CAT2, 150)
}
